function [NormData] = normalizeData_MicheleWyss(Data)
...
%% Transpose to better be able to wrap head around it...
X = Data';
...
%  just directly use the built in function std that compute the standard deviation
sigma = std(X(:));
